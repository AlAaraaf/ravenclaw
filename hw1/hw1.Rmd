...
```
Use 10-fold cross validation to calculate the average error of each model (under different parameter combination). According to the tuning result, radial kernel seperates the data best. And the best cost parameter is 100.
...
After removing the effect of digit-specific means and applying PCA, the fist 46 components can explain at least 80% of the total variance in the training dataset.
